...
from trainer import GaussianSQVAETrainer, VmfSQVAETrainer, SQ_FastFlow_Trainer
...
def arg_parse():
    ...
    parser.add_argument(
        "-s", "--sub_category", default="bottle", help="category")
    parser.add_argument(
    ...
    parser.add_argument(
        "--detection", action="store_true", help="run detection")
...
def load_config(args):
    ...
    cfgs.category = args.sub_category
    cfgs.flags.save = args.save
    cfgs.flags.detection = args.detection
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = get_loader(
        cfgs.dataset.name, cfgs.path_dataset, args.sub_category, cfgs.train.bs, cfgs.nworker)
    ...
    elif cfgs.model.name == "GaussianSQVAE_FastFlow":
        trainer = SQ_FastFlow_Trainer(cfgs, flgs, train_loader, val_loader, test_loader)
    else:
