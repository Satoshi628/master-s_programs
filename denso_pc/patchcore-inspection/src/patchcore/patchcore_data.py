...
class PatchCore(torch.nn.Module):
    ...
    def _fill_memory_bank(self, input_data):
        ...
        sampled_features, indices, distance, change_data_dist = self.featuresampler.run(features, self.features, self.indices)
        ...
        if self.distance is None:
            ...
            self.distance = np.concatenate([self.distance, distance])
        self.anomaly_scorer.fit(detection_features=[sampled_features])
        return change_data_dist
