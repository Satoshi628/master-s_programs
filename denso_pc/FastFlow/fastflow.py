...
class FastFlow(nn.Module):
    def __init__(
        ...
        if backbone_name in [const.BACKBONE_CAIT, const.BACKBONE_DEIT]:
            ...
            channels = [768]
            scales = [16]
        elif backbone_name in [const.BACKBONE_EFFIAD_SMALL, const.BACKBONE_EFFIAD_MEDIUM]:
    ...
    def forward(self, x):
        ...
        if isinstance(
            ...
            if self.backbone_name in [const.BACKBONE_EFFIAD_SMALL, const.BACKBONE_EFFIAD_MEDIUM]:
                features = [features]
        ...
        if not self.training:
            ...
            ret["anomaly_maps"] = anomaly_map_list
