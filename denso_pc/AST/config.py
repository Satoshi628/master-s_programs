...
# data settings
dataset_dir = '/mnt/kamiya/dataset/DENSO_D/' # parent directory of class folders
feature_dir = 'data/features_densor/' # directory where features are stored and loaded from
use_3D_dataset = False # is MVTec 3D used?
pre_extracted = True # were feature pre-extracted with extract_features? (recommended)
modelname = "Denso" # export evaluations/logs with this name
print(modelname)

# inputs
img_size = (320, 480)  #H, W
img_dims = [3] + list(img_size)
depth_len = (img_size[0] // 4, img_size[1] // 4) # width/height of depth maps
...
map_len = (img_size[0] // 32, img_size[1] // 32) # feature map width/height (dependent on feature extractor!)
