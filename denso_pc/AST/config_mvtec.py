...
# data settings
dataset_dir = '/mnt/kamiya/dataset/MVtec_AD/' # parent directory of class folders
...
modelname = "MVtecAD" # export evaluations/logs with this name
print(modelname)

# inputs
img_len = 224 # width/height of input image
img_size = (img_len, img_len) 
img_dims = [3] + list(img_size)
depth_len = (img_len // 4, img_len // 4) # width/height of depth maps
...
map_len = (img_len // 32, img_len // 32) # feature map width/height (dependent on feature extractor!)
