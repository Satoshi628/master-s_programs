...
def build_VQ_FastFlow(pretrain_path, backbone_name, flow_steps, input_size, n_embed=512, conv3x3_only=False, hidden_ratio=1.0):
    model = VQ_FastFlow(backbone_name, flow_steps, input_size, conv3x3_only, hidden_ratio, n_embed)
    # print(model)
    # input()
