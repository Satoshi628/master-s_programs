...
def plot_segmentation_images(
    ...
    for image_path, mask_path, anomaly_score, segmentation, vis in tqdm.tqdm(
        zip(image_paths, mask_paths, anomaly_scores, segmentations, visualize),
        ...
        seg = axes[2].imshow(segmentation, norm=Normalize(vmin=0, vmax=1))
        axes[3].imshow(vis.transpose(1, 2, 0))
        f.colorbar(seg, ax=axes[2])
