...
from TransUNet_sample.networks.vit_seg_modeling import VisionTransformer as ViT_seg
from TransUNet_sample.networks.vit_seg_modeling import CONFIGS as CONFIGS_ViT_seg
