...
from utils.loss import IoULoss, get_class_rate_weight, get_class_balancing_weight, Contrastive_Loss_moepy, Contrastive_Loss_moepy_tvmf
...
def main(cfg):
    ...
    if cfg.train_conf.use_Loss == "IoU":
        ...
        criterion = Contrastive_Loss_moepy_tvmf(n_class,
