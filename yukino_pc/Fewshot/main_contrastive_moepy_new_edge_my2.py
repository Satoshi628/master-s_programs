...
from utils.loss import IoULoss, DiceLoss, get_class_rate_weight, get_class_balancing_weight, Contrastive_Loss_moepy, Contrastive_Loss_moepy7
...
def main(cfg):
    ...
    elif cfg.train_conf.use_Loss == "Dice":
        criterion = DiceLoss(n_class, weight=weight)
    elif cfg.train_conf.use_Loss == "CL-moepy":
        criterion = Contrastive_Loss_moepy7(n_class,
