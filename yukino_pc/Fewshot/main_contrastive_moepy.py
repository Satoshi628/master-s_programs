...
from utils.loss import IoULoss, get_class_rate_weight, get_class_balancing_weight, Contrastive_Loss_moepy, Contrastive_Loss_moepy2
...
def main(cfg):
    ...
    if cfg.train_conf.use_Loss == "IoU":
        ...
        criterion = Contrastive_Loss_moepy(n_class, weight=weight)
        #criterion = Contrastive_Loss_moepy2(n_class, choice_type=cfg.train_conf.choice_type, edge_range=cfg.train_conf.edge_range, n=cfg.train_conf.choice_num, weight=weight)
        print("ok")
    else:
