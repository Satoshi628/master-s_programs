...
class SquareLoss(torch.nn.Module):
    ...
    def forward(self, bh_0, bh_1, bh_2, btargets1, y, bh_00, bh_11, bh_22, btargets2, yy):   # output 出力(64次元)  targets ラベル
        ...
        for h_0, h_1, h_2, targets1, h_00, h_11, h_22, targets2 in zip(bh_0, bh_1, bh_2, btargets1, bh_00, bh_11, bh_22, btargets2):
