...
from models.resnet2D import resnet2D50, resnet2D18, resnet2D18_atten
...
def dataload(cfg):
    ...
    val_dataset = Eye_Loader(root_dir=cfg.root_dir, dataset_type='val', split=cfg.split, transform=val_transform, use_age=cfg.use_age, use_sex=cfg.use_sex)
