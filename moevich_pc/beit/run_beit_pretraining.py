...
def get_args():
    ...
    # Dataset parameters
    parser.add_argument('--use_NII', default=False, action='store_true',
                        help='use NII data')
    parser.add_argument('--use_Eye', default=False, action='store_true',
                        help='use Eye data')
    parser.add_argument('--data_path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--split', default='train', type=str,
                        help='split')
    parser.add_argument('--split_paths', default='/mnt/HDD1/edit_dataset/new_anno_20200302tsukuba_all.txt,/mnt/HDD1/edit_dataset/20200708kokuritsu.txt', required=True, nargs="*", type=str,
                        help='split paths')
    ...
    args.split_paths = " ".join(args.split_paths)
    args.split_paths = sorted(args.split_paths.split(","))
    return args
