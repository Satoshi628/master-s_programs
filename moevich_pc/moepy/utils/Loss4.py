...
class SquareLoss(torch.nn.Module):
    ...
    def forward(self, bh_0, bh_1, bh_2, btargets, y):   # output 出力(64次元)  targets ラベル
        ...
        for h_0, h_1, h_2, targets in zip(bh_0, bh_1, bh_2, btargets):
        ...
        return loss0_sum, loss1_sum, loss2_sum, loss4_sum
