...
def resnet2D50(in_c=3, num_classes=1, non_local=True):
...
def resnet2D34(in_c=3, num_classes=1, non_local=False):
...
def resnet2D18(in_c=3, num_classes=1, non_local=False):
