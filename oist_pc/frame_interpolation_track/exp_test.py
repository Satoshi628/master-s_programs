...
#----- Module -----#
from utils.dataset import OIST_Loader, OIST_Loader_30FPS, collate_delete_PAD
...
def dataload(cfg):
    ...
    test_dataset = OIST_Loader_30FPS(Staining="GFP-Mid", mode="test", split=0, length=4, transform=test_transform)
    #move_speed_max = OIST_Loader_30FPS(Staining="GFP-Mid", mode="train", split=0, length=16).get_max_move_speed()
