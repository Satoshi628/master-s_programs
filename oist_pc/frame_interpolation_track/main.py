...
def dataload(cfg):
    ...
    train_dataset = OIST_Loader(Staining=cfg.OIST.Staining, mode="train", split=cfg.OIST.split, length=16, delay=cfg.parameter.delay, transform=train_transform)
    val_dataset = OIST_Loader(Staining=cfg.OIST.Staining, mode="val", split=cfg.OIST.split, length=16, delay=cfg.parameter.delay, transform=val_transform)
