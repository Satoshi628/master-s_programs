...
from utils.loss import IoULoss, get_class_rate_weight, get_class_balancing_weight, Contrastive_Loss, Contrastive_Loss_classbalance, Contrastive_Loss_edge
...
def main(cfg):
    ...
    elif cfg.train_conf.use_Loss == "CL":
        criterion = Contrastive_Loss(n=cfg.train_conf.choice_num, weight=weight)
    elif cfg.train_conf.use_Loss == "CL-CB":
        criterion = Contrastive_Loss_classbalance(n_class=n_class, n=cfg.train_conf.choice_num, weight=weight)
    elif cfg.train_conf.use_Loss == "CL-edge":
        criterion = Contrastive_Loss_edge(n_class=n_class, edge_range=cfg.train_conf.edge_range, n=cfg.train_conf.choice_num, weight=weight)
        print("iine")
    else:
