...
def dataload(cfg):
    ...
    if cfg.dataset == "OIST":
        ...
        train_dataset = OISTLoader(root_dir=cfg.OIST.root_dir, mode="train", Staning=cfg.OIST.Staning, split=cfg.OIST.split, length=cfg.OIST.length, transform=train_transform)
        val_dataset = OISTLoader(root_dir=cfg.OIST.root_dir, mode="val", Staning=cfg.OIST.Staning, split=cfg.OIST.split, length=cfg.OIST.length, transform=val_transform)
