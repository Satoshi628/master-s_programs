...
def dataload(cfg):
    ...
    if cfg.dataset == "OIST":
        ...
        source_dataset = OISTLoader(root_dir="/mnt/kamiya/dataset/OIST/LowDensity_mov", mode="train", Staning="Low", split=cfg.OIST.split, length=cfg.OIST.length, transform=train_transform)
        target_dataset = OISTLoader(root_dir="/mnt/kamiya/dataset/OIST/LowDensity_mov", mode="train", Staning="Low", split=cfg.OIST.split, length=cfg.OIST.length, transform=train_transform)
