...
def dataload(dataset_name, cfg):
    ...
    if dataset_name == "ACDC":
        test_dataset = ACDC_Loader(root_dir=cfg.root_dir, mode="test", split=cfg.test_split, transform=test_transform)

    if dataset_name == "Synapse_Multi_Organ":
        test_dataset = Synapse_Multi_Organ_Loader(root_dir=cfg.root_dir, mode="test", split=cfg.test_split, transform=test_transform)
