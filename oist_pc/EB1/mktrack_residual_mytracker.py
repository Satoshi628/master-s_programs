...
#----- Module -----#
from models.Correlation_Filter import Wide_ResNet50V2_residual, ResidualMap
from utils.dataset import Zenigoke_Loader_Exp
from utils.MPM_to_track import MPM_to_Track_kalman, global_association_solver
...
def main(cfg):
    ...
    tracker = MPM_to_Track_kalman(move_speed=[11.77*1.5, 11.77*3], init_move=[0, 0.])
