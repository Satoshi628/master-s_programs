...
def dataload(cfg):
    ...
    test_dataset = OISTLoader_add(mode="test", data=cfg.parameter.data, length=16, transform=test_transform)

    mode_limit_dataset = OISTLoader(mode="train", data=cfg.parameter.data, length=16)
